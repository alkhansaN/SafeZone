...
<link rel="stylesheet" href="assets/css/NavmenuStyle.css">
<!--
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Safe zone cloud</h2></a>
...
$(function(){
   $(".toggle-nav").on('click',function(e){
      ...
      popmenu({
    		items : {
    			home : {name : 'Share', icon : '<i class="fa "></i>', divid : true},
    			fb : {name : 'Rename', icon : '<i class="fa "></i>'},
    			tw : {name : 'permissions', icon : '<i class="fa "></i>', divid : true},
                about : {name : 'download', icon : '<i class="fa "></i>'},
                contact : {name : 'delete', icon : '<i class="fa "></i>'},
    		},
